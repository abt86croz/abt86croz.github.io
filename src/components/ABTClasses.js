    ...
    <div className="description-container">
        <div className='content'>
            ...
            <div className="description">
                ...
                <p>This is available to students who can walk without crutches, walkers, or wheelchairs, and follow multi-step directions.<Link to='/classes/special-needs-dance-class'> Read more...</Link>
                </p>
            </div>
            <hr />
            <div className="description">
            ...
            <div className="description">
                ...
                <p className="italic">For more information, email us at <span className="bold">Dance@aBallet.org</span>, or call us at <span className="bold">434.823.8888</span>.</p>
            ...
            <a className="bt" href={FreeClassCupon} target="_blank">Try a Free Class<RightArrow /></a>
        </div>
    </div>
...
const EspecialNeeds = () => (
    <div className="special-needs-container">
        <div className='content'>
            ...
            <p>During the 1970’s Sally taught ballet to children with Down Syndrome while she attended W.T. Woodson High School in Fairfax Virginia. Sally Hart says, “I love to see how excited the children get when something clicks, the tiniest things mean so much to them, and it’s just so rewarding for me.”</p>
            ...
            <p>For more information, please call us at <span className="bold">434.823.8888</span> or email us at <span className="bold">Dance@aBallet.org.</span></p>
        </div>
