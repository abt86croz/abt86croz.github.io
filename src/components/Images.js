...
export const VeronicaImage = () => (
  <img src={VeronicaImg} alt="Veronica Piller" title="Sally Hart" />
)
export const AshleyImage = () => <img src={AshleyImg} alt="Ashley Geisler" title="Ashley Geisler" />
export const NickyImage = () => <img src={NickyImg} alt="Nicky Coelho" title="Nicky Coelho" />
export const AmandaImage = () => (
  <img src={AmandaImg} alt="Amanda Jo Parks" title="Amanda Jo Parks" />
)

export const SarahImage = () => <img src={SarahImg} alt="Sarah Gillespie" title="Sarah Gillespie" />
...
export const KeithImage = () => <img src={KeithImg} alt="Keith Lee" title="Keith Lee" />
export const RoderickImage = () => <img src={RoderickImg} alt="Roderick Davis" title="Roderick Davis" />
