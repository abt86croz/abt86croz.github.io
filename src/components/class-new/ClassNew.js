...
const NewClasses = () => (
  <div className="new-classes-container">
    ...
    <div className="content">
      <div className="description">
        <p className="sub-title bold">
          ...
          <span className="sub-title-specs">
            8-Week Session: $149 • 1-Hour Class
          </span>
        </p>
        <p>
          An open level ballet class for homeschool students with daytime
          scheduling needs and availability. This class is for the older
          beginner ballet student. The perfect fit for all students, from the
          ballet enthusiast to the serious dancer. Focusing on a variety of
          steps from plies to pirouettes, this class also teaches body alignment
          and awareness, proprioception, strength, and flexibility.
        </p>
      </div>
      <hr />
      <div className="description">
      ...
      <div className="description">
        <p className="sub-title bold">
          BABY AND ME BARRE BOOTCAMP • BABY WEARING
          <span className="sub-title-specs">
            8-Week Session: $149 • 45-Minute Class
          </span>
        </p>
        <p>
      ...
      <div className="description">
        <p className="sub-title bold">
          MOVEMENT THERAPY THROUGH DANCE • Ages 2-8
          <span className="sub-title-specs">
            8-Week Session: $149 • 1-Hour Class
          </span>
        </p>
