  ...
  <div className="summer-program-container">
    ...
    <div className="summer-content-wrap">
      <div className="summer-content">
        ...
        <p>
          ...
          technique, flexibility, coordination, balance, creative movement and games, and stories of
          the classical ballets. The dancers decorate their own costumes (that they keep after the
          camp), and share a demonstration recital on the last day. Craft supplies & snacks are
          included.
        </p>
        ...
        <p className="date">July 29 - August 2 | Advanced | Monday - Friday | 9am - 4pm | $335</p>
        <p>
          For dancers that would like to fully immerse themselves in the world of ballet and dance,
          and take a more serious step with their training. These camps offer ballet technique,
          pointe*, variations, jazz, modern, character, Capoeira, theatre, West Coast Swing, and
          Pilates. *For dancers who are already en pointe prior to signing up for the camp. Dancers
          who are not yet dancing en pointe may take the pointe classes as pre-pointe, and will gain
          strength in preparation for pointe work.
        </p>
      </div>
    </div>
    <div className="summer-schedule">
      <div className="column-1">
        ...
        <p>
          Ballet III • Intermediate Classes
          <br />
