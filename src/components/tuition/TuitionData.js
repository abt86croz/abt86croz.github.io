...
export const tuitionDiscounts = [
  ...
  { numberOfClasses: "3", price: "$15.04", id: 4 },
  { numberOfClasses: "4", price: "$14.38", id: 5 },
  { numberOfClasses: "5", price: "$13.17", id: 6 },
  { numberOfClasses: "6", price: "$12.35", id: 7 },
  { numberOfClasses: "7", price: "$11.75", id: 8 },
  { numberOfClasses: "8", price: "$11.32", id: 9 },
  { numberOfClasses: "9", price: "$10.97", id: 10 },
  { numberOfClasses: "10", price: "$10.33", id: 11 },
];

export const fallTuitionDiscounts = [
  { numberOfClasses: "30 Minute class", price: "$76", id: 1 },
  { numberOfClasses: "45 Minute class", price: "$80", id: 2 },
  { numberOfClasses: "1 Hour class", price: "$86", id: 3 },
  { numberOfClasses: "1.25 hour class", price: "$90", id: 4 },
  { numberOfClasses: "1.50 Hour class", price: "$92", id: 5 },
];
